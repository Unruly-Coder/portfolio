...
class Resources extends EventEmitter {
  ...
  private textureItems: Record<keyof typeof textures, Texture> = {} as Record<
    keyof typeof textures,
    Texture
  >;
  private gltfItems: Record<keyof typeof gltfs, GLTF> = {} as Record<
    keyof typeof gltfs,
    GLTF
  >;
  private audioItems: Record<keyof typeof sounds, Howl> = {} as Record<
    keyof typeof sounds,
    Howl
  >;
  private fontItems: Record<keyof typeof fonts, Font> = {} as Record<
    keyof typeof fonts,
    Font
  >;
